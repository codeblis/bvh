...
const EVENTOS = [
	{
		id: "evt-1",
		fecha: "20 sep",
		titulo: "Webinar: Perspectivas macro Cuba 2026-2027",
		tipo: "Gratuito",
		modalidad: "Online",
	},
	{
		id: "evt-2",
		fecha: "05 oct",
		titulo: "Panel: Experiencias de listado en mercados emergentes",
		tipo: "Miembros",
		modalidad: "Híbrido",
	},
	{
		id: "evt-3",
		fecha: "18 oct",
		titulo: "Taller: Modelado financiero para MIPYMES",
		tipo: "$150",
		modalidad: "Presencial",
	},
	{
		id: "evt-4",
		fecha: "02 nov",
		titulo: "Conferencia: El rol de la diáspora en el capital cubano",
		tipo: "Gratuito",
		modalidad: "Online",
	},
];
			...
			<section className="mx-auto max-w-7xl px-6 py-8">
				...
				<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
					{filtrados.map((c) => (
						<article
							key={c.id}
							className="relative rounded-xl border border-border bg-background p-6 transition-colors hover:bg-card hover:border-primary/50"
						>
					...
					<div className="mb-10 flex flex-wrap items-end justify-between gap-4">
						<div>
							...
							<h2 className="font-serif text-2xl leading-tight text-foreground md:text-4xl">
								Webinars, talleres y{" "}
								<span className="italic text-primary">encuentros</span>
							</h2>
						</div>
					</div>
						...
						<table className="w-full text-left text-[13px]">
							...
							<tbody className="divide-y divide-border">
								{EVENTOS.map((e) => (
									...
									>
										<td className="px-5 py-4 font-mono text-[12px] text-primary">
											{e.fecha}
										</td>
										...
										<td className="hidden px-5 py-4 lg:table-cell text-muted-foreground">
											{e.modalidad}
										</td>
					...
					<div className="relative rounded-2xl border border-border bg-card/70 p-8 md:p-12 shadow-[var(--shadow-elegant)] backdrop-blur text-center">
						...
						<h3 className="font-serif text-2xl leading-tight text-foreground md:text-4xl max-w-2xl mx-auto">
							...
							<span className="italic text-primary">
								Analista Certificado BVH
							</span>
						</h3>
						<p className="mt-4 max-w-xl mx-auto text-[14px] leading-relaxed text-muted-foreground">
							Completa el itinerario de 3 cursos obligatorios + 2 electivos y
							presenta el caso final. Certificación reconocida por el ecosistema
							BVH-HSE para asesores, directivos y analistas.
						</p>
						<div className="mt-8">
							<Link
